...
@section('content')
			...
			<section class="default-banner active-blog-slider">
					<div class="item-slider relative" style="background: url({{ asset('tmplt/img/slider1.jpg') }});background-size: cover;">
							...
							<div class="row fullscreen justify-content-center align-items-center">
								<div class="col-md-10 col-12">
									<div class="banner-content text-center">
										...
										<a target="_blank" href="https://maps.app.goo.gl/ktGvAEF1vqdjDKXQ7" class="text-uppercase header-btn">JELAJAHI SEKARANG</a>
									</div>
								</div>
					...
					<div class="item-slider relative" style="background: url({{ asset('tmplt/img/slider2.jpg') }});background-size: cover;">
						<div class="overlay" style="background: rgba(0,0,0,.3)"></div>
						<div class="container">
							<div class="row fullscreen justify-content-center align-items-center">
								<div class="col-md-10 col-12">
									<div class="banner-content text-center">
										...
										<p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod temp <br>
										or incididunt ut labore et dolore magna aliqua. Ut enim ad minim.</p>
										<a href="https://maps.app.goo.gl/ktGvAEF1vqdjDKXQ7" class="text-uppercase header-btn">JELAJAHI SEKARANG</a>
									</div>
								</div>
							</div>
						</div>
					</div>
					<div class="item-slider relative" style="background: url({{ asset('tmplt/img/slider3.jpg') }});background-size: cover;">
						<div class="overlay" style="background: rgba(0,0,0,.3)"></div>
						<div class="container">
							<div class="row fullscreen justify-content-center align-items-center">
								<div class="col-md-10 col-12">
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-40 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Mengapa Harus Ke DeManduk</h1>
					...
					<div class="single-info row mt-40">
						<div class="col-lg-6 col-md-12 mt-120 text-center no-padding info-left">
							<div class="info-thumb">
								<img src="{{ asset('tmplt/img/about-img.jpg') }}" class="img-fluid" alt="">
							</div>
						</div>
						<div class="col-lg-6 col-md-12 no-padding info-rigth">
							<div class="info-content">
								<h2 class="pb-30">Sedikit Tentang <br>
								Waduk Manduk<br>
								(DeManduk)</h2>
								<p>
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-30 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Ivent Yang Sedang di Laksanakan</h1>
					...
					<div class="row justify-content-center d-flex">
						<div class="active-works-carousel mt-40 col-lg-8">
							<div class="item">
								<img class="img-fluid" src="{{ asset('tmplt/img/why.jpg') }}" alt="">
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Fasilitas Yang Ada Disini</h1>
								<p>Who are in extremely love with eco friendly system.</p>
							</div>
						</div>
					</div>						
			...
			<section class="faq-area section-gap" id="faq">
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Skala Aktifitas Wisata</h1>
								<p>Menunjukkan perkembangan dan antusiasme pengunjung di kawasan Waduk DeManduk.</p>
							</div>
						</div>
					</div>							
						...
						<div class="faq-content col-lg-9 col-md-9">
							<div class="single-faq">
								<h2 class="text-uppercase">
									Apakah waduk ini ramai dikunjungi?
								</h2>
								<p>
									Waduk DeManduk terus menjadi destinasi favorit masyarakat lokal dan luar kota. Setiap tahunnya, ribuan pengunjung datang untuk menikmati keindahan alam, berperahu, dan bersantai bersama keluarga.
								</p>
							</div>
							<div class="single-faq">
								<h2 class="text-uppercase">
									Bagaimana tren kunjungan wisata?
								</h2>
								<p>
									Rata-rata wisatawan setiap bulan menunjukkan peningkatan stabil, terutama di musim liburan dan akhir pekan. Ini menjadi bukti bahwa kawasan waduk terus berkembang sebagai pusat wisata alam yang menarik.
								</p>
							</div>
							<div class="single-faq">
								<h2 class="text-uppercase">
									Apa saja kegiatan ekonomi yang tumbuh?
								</h2>
								<p>
									Lebih dari seribu pelaku UMKM kini beroperasi di sekitar waduk — mulai dari kuliner, oleh-oleh khas, hingga penyewaan wahana air — membantu meningkatkan ekonomi masyarakat sekitar.
								</p>
							</div>												
						</div>									
					</div>
			...
			<section class="video-area pt-40 pb-40">
				...
				<div class="container">
					<div class="video-content">
						<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="play-btn"><img src="{{ asset('tmplt/img/play-btn.png') }}" alt=""></a>
			...
			<section class="contact-area section-gap" id="contact">
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Keritik dan saran</h1>
								<p>Menunjukkan perkembangan dan antusiasme pengunjung di kawasan Waduk DeManduk.</p>
							</div>
						</div>
					</div>										
